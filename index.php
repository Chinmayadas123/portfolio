        ...
        <div class="container">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto  mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="logout" href="logout.php"><i class="fa fa-power-off"></i>Sign Up</a>
                            </li>
                            <img src="pic/moon.png" class="img-fluid" id="toggle">
                        </ul>
            ...
            ?>
                <div class="baner-cont">
                    ...
                    <a href="resume.php" target="_blanck" class="btn baner-btn">Download Resume</a>
                </div>
            <?php } else {
            ?>
                <div class="baner-cont">
                    ...
                    <h3>Chinmaya Das</h3>
                    <p>I am Front End Developer </p>
                    <p>Register here for developing your portfolio</p>
            ...
            <div class="row">
                <div class="col-lg-7 col-md-7 abtbox">
                    <div class="btcont">
                        ...
                        <button class="m-btn">Hire Me</button>
                    </div>
                </div>
                <div class="col-lg-5 col-md-5">
                    <div class="image">
                        <img src="pic/b3.png" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 qual">
                    ...
                    <p>
                        -Done <?php echo "{$rowq['highest_qual']}"; ?> from <?php echo "{$rowq['hclg_name']}"; ?> with <?php echo "{$rowq['hmark']}%"; ?>( <?php echo "{$rowq['hpassing_year']}"; ?>). <br>
                        - <?php echo "{$rowq['grad']}"; ?> from <?php echo "{$rowq['grad_clg']}"; ?> with <?php echo "{$rowq['grad_mark']}%"; ?>( <?php echo "{$rowq['grad_passing_year']}"; ?>).

                    </p>
                    <p>

                        -12th from <?php echo "{$rowq['xii_clg']}"; ?> with <?php echo "{$rowq['xii_mark']}%"; ?> (<?php echo "{$rowq['xii_passing_year']}"; ?> ). <br>
                        -10th from <?php echo "{$rowq['x_school']}"; ?> with <?php echo "{$rowq['x_mark']}"; ?> (<?php echo "{$rowq['x_passing_year']}"; ?> ).
                            ...
                            <div class="col-md-4 d-flex align-items-stretch">
                                <div class="info-wrap">
                                    ...
                                    <div class="dbox w-100 d-flex align-items-start">
                                        ...
                                        <div class="text pl-3">
                                            <p><span>Address :</span><span id="addr"> bhrmra pura ganjam pin-761209</span></p>
                                        </div>
                                    </div>
                ...
                <div class="footer">
                    <div class="row fbox">
                        <div class="col-lg-12 col-sm-12">
                            <p class="text-center">@2021 <b> PortFolio </b>all rights are reserved</p>
                        </div>
                        <div class="col-lg-12 col-sm-12">
                            <p class="text-center">Designed By Chinmaya Das</p>
                        </div>
                        <div class="col-lg-12 col-sm-12">
                            <a href="personal.php">Add Information</a>
                        </div>
